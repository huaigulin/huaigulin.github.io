    ...
    >
      ...
      <Grid item xs={12} className={classes.sbHive}>
        <div className={classes.hive}>
          ...
          />
          <HiveCell tabIndex='2' letter={letter2} setLetter={setLetter2} />
          <HiveCell tabIndex='3' letter={letter3} setLetter={setLetter3} />
          <HiveCell tabIndex='4' letter={letter4} setLetter={setLetter4} />
          <HiveCell tabIndex='5' letter={letter5} setLetter={setLetter5} />
          <HiveCell tabIndex='6' letter={letter6} setLetter={setLetter6} />
          <HiveCell tabIndex='7' letter={letter7} setLetter={setLetter7} />
        </div>
      </Grid>
