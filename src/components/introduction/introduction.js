...
export default () => {
  ...
  return (
    ...
    >
      ...
      >
        Designer, creative technologist, full-stack engineer.
      </h3>
      {/* <p
                style={{
                    fontFamily: "semplicitapro, sans-serif",
      ...
      >
        Currently, I'm a student of the MFA Design and Technology program at
        Parsons School of Design.
      </p>
      <p style={{ display: "flex", alignItems: "center" }}>
        <ArrowDownwardIcon fontSize='inherit' /> Scroll down to see a couple of
        my projects.
      </p>
    </div>
  );
