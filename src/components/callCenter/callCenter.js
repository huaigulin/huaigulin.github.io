          ...
          <Grid item>
            <Grid container spacing={4} alignItems='center'>
              <Grid item xs={12} md={6}>
                ...
                >
                  <b>
                    Using <i>speech recognition</i>, <i>text to speech</i>,{" "}
                    <i>intent recognition</i> and <i>frontend animation</i> to
                    showcase the company's technical expertise in building an
            ...
            <Grid container justify='center' spacing={4}>
              <Grid item>
                <Button
                  ...
                  onClick={() => {
                    window.open("https://youtu.be/v6TqeO2SzT0", "_blank");
                  }}
                  size='large'
                >
                  View on YouTube
